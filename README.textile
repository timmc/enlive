...
Binding @*xml-style-self-close*@ to false while realizing an emitted markup
sequence will use HTML-style slash-less self-closing tags, e.g. &lt;img&gt;
instead of &lt;img/&gt;.

Example:
<pre>
  (let [f (java.io.File. "some/example/file.html")]
    (binding [*xml-style-self-close* false]
      (apply str (emit* (html-resource f)))))
</pre>
